...
def main():
    try:
        ...
        button_1 = DebounceButton(5, holding_register[0x05])# 2nd value is debounce duration
        button_2 = DebounceButton(4, holding_register[0x05])# 2nd value is debounce duration
        coil_2 = Pin(0, Pin.OUT, Pin.PULL_DOWN)
        coil_1 = Pin(2, Pin.OUT, Pin.PULL_DOWN)

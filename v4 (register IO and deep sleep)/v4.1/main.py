...
def main():
    try:
        ...
        input_register, holding_register, reg_lengths = vars_regs.assignParams(loaded_parameters)
        # Initialize output pins for coils and buttons 
        button_1 = DebounceButton("PB9", holding_register[0x05])# 2nd value is debounce duration
        button_2 = DebounceButton("PB10", holding_register[0x05])# 2nd value is debounce duration
        coil_2 = Pin("PB8", Pin.OUT)
        coil_1 = Pin("PB7", Pin.OUT)
        ...
        while True:
            ...
            response_data = 0
            gpio_b = mem32[const.GPIO_B_ADDRESS]
            ...
            if uart.any():
                ...
                if relay_status == 1:
                    mem32[const.GPIO_B_ADDRESS] &= 0b1111111101111111
                    gpio_b = mem32[const.GPIO_B_ADDRESS]
                    relay_status = 0
                ...
                if data is not None:
                    ...
                    if response_error is None:
                        ...
                        response_data, input_register, holding_register = handle_request.handleRequest(\
                                          data, gpio_b, input_register, holding_register) # Initial part of response
                        ...
                        num_bytes_sent = uart.write(response) # Write response to the UART
                        print("Number of bytes sent: ", num_bytes_sent)
                    else:
            ...
            if(relay_status == 1):
                mem32[const.GPIO_B_ADDRESS] |= 0b0000000010000000
                gpio_b = mem32[const.GPIO_B_ADDRESS]
            ...
            if button_1.isPressed():
                BUTTON_COUNTER_1 = vars_regs.button1Change(button_1, BUTTON_COUNTER_1)
            ...
            if button_2.isPressed():
                BUTTON_COUNTER_2 = vars_regs.button2Change(button_2, BUTTON_COUNTER_2)
